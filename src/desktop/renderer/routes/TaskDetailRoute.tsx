...
export default function TaskDetailRoute() {
  ...
  return (
    <div className="relative h-screen flex flex-col lg:flex-row bg-bg-page p-4 gap-4">
      <div className={`desktop-window-drag-region absolute inset-x-0 top-0 z-10 ${needsMacDesktopHeaderOffset ? "h-10" : "h-8"}`} />
      <CollapsibleSidebar defaultCollapsed={state.sidebarDefaultCollapsed} showHint={!state.sidebarHintDismissed}>
        <div className={`flex flex-col gap-4 ${needsMacDesktopHeaderOffset ? "pt-10" : ""}`}>
          <div className="desktop-window-no-drag flex items-center justify-between gap-3">
      ...
      <main className="flex-1 flex flex-col min-h-0 min-w-0">
        {hasTerminal ? (
          <div className="flex-1 flex flex-col min-h-0 rounded-lg overflow-hidden shadow-md">
            <div className="desktop-window-no-drag bg-terminal-chrome flex items-center gap-2 px-4 py-2.5 shrink-0">
