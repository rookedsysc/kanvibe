...
class FakeConnectionStore implements ConnectionStore {
  @override
  Future<DesktopConnection?> read() async => const DesktopConnection(
    host: '127.0.0.1',
    port: 9736,
    token: 'test-token',
  );
...
class FakeDesktopClient implements DesktopClient {
  FakeDesktopClient({this.board = const {}, this.surfaces, this.surfacesError});
